  ...
  return (
    <nav>
      <List>
        ...
        <Link to="/banner"><ListItem active={router.isActive('/banner')} primaryText="Banner" /></Link>
        ...
        <Link to="/pop-over"><ListItem active={router.isActive('/pop-over')} primaryText="Pop Over" /></Link>
        ...
        <Link to="/with-theme"><ListItem active={router.isActive('/with-theme')} primaryText="With theme" /></Link>
      </List>
    </nav>
  );
}
