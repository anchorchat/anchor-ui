...
describe('Slider.getStyles', () => {
  ...
  describe('filled', () => {
    ...
    it('should combine styles', () => {
      const style = getStyles.filled({}, {}, { color: 'red' });
    ...
    it('should add percentage styles', () => {
      const style = getStyles.filled({}, 0.5);
  ...
  describe('remaining', () => {
    ...
    it('should combine styles', () => {
      const style = getStyles.remaining({}, { color: 'red' });
  ...
  describe('button', () => {
    it('should get styles', () => {
      const style = getStyles.button({}, 0);
    ...
    it('should add percentage styles', () => {
      const style = getStyles.button({}, 0.5);
