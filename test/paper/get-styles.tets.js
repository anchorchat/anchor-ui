...
describe('Paper: getStyles', () => {
  it('should get root styles', () => {
    ...
    expect(style).to.have.all.keys('padding', 'borderRadius', 'boxShadow', 'background', 'margin');
  });
  ...
  it('should combine styles', () => {
    ...
    expect(style).to.be.an('object');
    expect(style).to.have.all.keys('padding', 'borderRadius', 'boxShadow', 'background', 'margin', 'color');
  });
});
